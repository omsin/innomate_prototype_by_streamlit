...
st.markdown(original_title, unsafe_allow_html=True)
image10 = Image.open('image/innomate_aws-12cut.jpg')
...
if sentence:
   ...
   my_file.write(file_content+sentence+"\n")
   my_file.seek(0)
